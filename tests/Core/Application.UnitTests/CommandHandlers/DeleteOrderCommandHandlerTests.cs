...
namespace Application.UnitTests.CommandHandlers
{
    public class DeleteOrderCommandHandlerTests
    {
        ...
        [Fact]
        public async Task HandleAsync_Should_VerifyDeleteCalledOnce()
        {
            // Arrange
            var orderId = 1;
            var command = new DeleteOrderCommand(orderId);
            ...
            // Assert
            _orderRepositoryMock.Verify(x => x.DeleteAsync(It.IsAny<Order>(), CancellationToken.None), Times.Once);
        }
    }
