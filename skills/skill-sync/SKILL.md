...
```yaml
# .agents/skills/blazor-expert/SKILL.md
metadata:
  version: "1.0"
  scope: [root]
  auto_invoke: "Creating or modifying Blazor components/pages"
```
...
| Action | Skill |
|--------|-------|
| Creating or modifying Blazor components/pages | `blazor-expert` |
```
